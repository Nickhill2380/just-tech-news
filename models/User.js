...
User.init(
    {
        ...
        password: {
            ...
            allowNull: false,
            validate: {
                // this means the password mut be at least four characters long
                len:[4]
            }
        }
    },
    {
        // TABLE CONIFIGURATION OPTIONS GO HERE(https://sequelize.org/v5/manual/models-definition.html#configuration))
